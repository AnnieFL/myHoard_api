...
usersRouter.put('/edit/:email', isAuth, isItself, (req, res) => usersController.editUser(req, res));

usersRouter.delete('/delete/:email', isAuth, isItself, (req, res) => usersController.deleteUser(req, res));
